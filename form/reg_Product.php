      ...
      <table width="804" height="225" border="1">
        <tbody>
          <tr class="titulo_fondo">
            <th colspan="4" class="titulo">REGISTRO DE PRODUCTOS</th>
          </tr>
          <tr>
            <td colspan="4">&nbsp;</td>
          </tr>
          ...
          <tr>
            ...
            <td width="209"><input name="nombre_Produc" type="text" required="required" id="nombre_Produc" title="nombre_Produc" maxlength="200"></td>
            <td width="115" align="right" class="textos_Lebel">REFERENCIA</td>
            <td width="251" align="left"><input name="referencia" type="text" required class="txtCuadros" id="referencia" title="referencia" maxlength="200"></td>
          </tr>
          <tr>
            <td class="textos_Lebel">PRECIO</td>
            <td><input name="precio_Produc" type="number" required title="precio_Produc" maxlength="10" id="precio_Produc"></td>
          ...
          <tr>
            ...
            <td align="left"><input name="categoria" type="text" required title="categoria" maxlength="50" id="categoria"></td>
      ...
      <table width="490" border="0">
        <tbody>
          <tr>
            ...
            <td width="151" align="center" valign="middle" nowrap="nowrap"><input name="btnEnviar" type="submit" class="btnEnviar" id="btnEnviar" formaction="../procesar/pro_Reg_Product.php" value="Registrar Producto"></td>
            <td width="144" align="center" valign="middle" nowrap="nowrap"><input name="modRegistro" type="button" class="btnEnviar" id="inicio" onClick="window.location = 'update_Producto.php'" title="modRegistro" value="Modificar Registro"></td>
